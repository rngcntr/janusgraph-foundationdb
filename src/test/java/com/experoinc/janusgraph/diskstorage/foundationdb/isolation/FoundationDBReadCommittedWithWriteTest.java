 ...
 */
@Testcontainers
public class FoundationDBReadCommittedWithWriteTest extends FoundationDBIsolationTest {

    @Override
    protected String getIsolationLevel() {
        return "read_committed_with_write";
    }
    ...
    public void testIsolationLevel() throws BackendException {
        ...
        assertEquals(FoundationDBTx.IsolationLevel.READ_COMMITTED_WITH_WRITE,
